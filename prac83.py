...
if __name__ == "__main__":
    ...
    '''
        for threshold in thresholds:
            ...
            lr.fit(X, Y)
            precision = cross_validation.cross_val_score(lr, X, Y, cv=5, scoring='precision')
            precision_rates.append(precision[0])
            recall = cross_validation.cross_val_score(lr, X, Y, cv=5, scoring='recall')
            recall_rates.append(recall[0])
            print("==============================================")
    '''